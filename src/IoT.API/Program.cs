...
builder.Services.AddScoped<EnviarComandoHandler>();
builder.Services.AddScoped<ConectarDispositivoHandler>();
builder.Services.AddScoped<DesconectarDispositivoHandler>();
builder.Services.AddScoped<ObtenerTelemetriaHandler>();
